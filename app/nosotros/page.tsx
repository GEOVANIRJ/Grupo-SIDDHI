...
import { Zap, Users, Star, Award } from 'lucide-react';
      ...
      <div className="pt-32">
        ...
        <div className="max-w-7xl mx-auto py-20 px-6 md:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            {/* Valor 1 */}
            <div className="group relative bg-white p-8 rounded-2xl border border-gray-200 hover:shadow-xl transition-all duration-300 hover:border-[#ff2e55]">
            ...
            {/* Valor 2 */}
            <div className="group relative bg-white p-8 rounded-2xl border border-gray-200 hover:shadow-xl transition-all duration-300 hover:border-[#2959c7]">
              <div className="absolute inset-0 bg-gradient-to-br from-[#2959c7]/5 to-[#fe3158]/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
              <div className="relative">
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[1, 2, 3].map((member) => (
                <div key={member} className="bg-white p-6 rounded-2xl border border-gray-200 hover:shadow-xl transition-all duration-300">
                  ...
                  <p className="text-gray-600 text-sm mb-4">Especialista en Diseño Láser</p>
                  <p className="text-gray-500 text-sm">Experto con más de 5 años de experiencia</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* CTA */}
          <div className="mt-20 text-center bg-white p-12 md:p-16 rounded-3xl border-2 border-gray-200">
